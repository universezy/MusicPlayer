...
public class TransportFlag {
    public static final String State = "TransportFlag.State";
    ...
    public static final String Pause = "TransportFlag.Pause";
    public static final String Last = "TransportFlag.Last";
